    ...
    return (
        <div className="w-[15%] flex flex-col justify-between items-center p-4 bg-[#171717]">
            ...
            <div className='flex flex-col items-center space-y-4'>
                <Popover>
                    <PopoverTrigger> <Avatar className='hover:cursor-pointer'>
                        <AvatarImage src="https://github.com/shadcn.png" />
                        <AvatarFallback>CN</AvatarFallback>
                    </Avatar></PopoverTrigger>
                    <PopoverContent className='bg-[#1A1C20] border-[#303131] text-white text-center hover:cursor-pointer hover:underline' onClick={() => {
